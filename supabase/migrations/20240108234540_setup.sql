...
AS $$
DECLARE
  project_url TEXT := 'https://yzvnvgechvmpcskegxkg.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl6dm52Z2VjaHZtcGNza2VneGtnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyMTI3NzY2MywiZXhwIjoyMDM2ODUzNjYzfQ.qlO1lwUSj--eVRCTqcmPTr_Ntv6y6HOEszUfjChRKmg'; -- full access needed for http request to storage
